...
st.write("""# Choose your dataset
            Then choose classifier""")

#dataset_name = st.selectbox('Select Dataset', ('Iris', 'Breast Cancer', 'Wine'))
dataset_name = st.sidebar.selectbox('Select Dataset', ('Iris', 'Breast Cancer', 'Wine'))
classifier_name = st.sidebar.selectbox('Select Classifier', ('KNN', 'SVM', 'Logistic Regression', 'Random Forest', 'Decision Tree'))
...
# PLOT
pca = PCA(2) # dimension = 2
X_projected = pca.fit_transform(X)
x1 = X_projected[:, 0]
x2 = X_projected[:, 1]

fig = plt.figure()
plt.scatter(x1, x2, c=y, alpha=0.77, cmap='viridis')
